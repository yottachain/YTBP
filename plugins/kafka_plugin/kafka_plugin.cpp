...
#include <eosio/kafka_plugin/kafka_types.hpp>
...
namespace eosio {
    ...
    using eosio::kafka_block_accept_st;
...
////////////
    ...
    void kafka_plugin::set_program_options(options_description &cli, options_description &cfg) {
        cfg.add_options()
                ("kafka-trx_accept_topic", bpo::value<std::string>()->default_value("eosio.trx-accept"),
                 "The topic for accepted transaction.")
                ("kafka-trx_applied_topic", bpo::value<std::string>()->default_value("eosio.trx-applied"),
                 "The topic for appiled transaction.")
                ("kafka-trx_transfer_topic", bpo::value<std::string>()->default_value("eosio.trx-transfer"),
                 "The topic for transfer transaction.")
                ("kafka-block_accepted_topic", bpo::value<std::string>()->default_value("eosio.block-accept"),
